...
class ContextBuilder:
    def __init__(self, *, user_id: str, session, base_prompt: str | None = None) -> None:
        self.user_id = user_id
        self.session = session
        self.base_prompt = base_prompt  # tenant system prompt; None -> global default
    ...
    def build_system(self, message: str) -> str:
        base = (self.base_prompt or SYSTEM_PROMPT).format(current_time=datetime.now().isoformat())
        parts: list[str] = [base]
